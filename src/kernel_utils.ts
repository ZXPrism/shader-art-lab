...
// helper to create a gpu uniform buffer containing one single f32
export function create_gpu_uniform_buffer_f32(device: GPUDevice, bufferName: string, value_f32: number): GPUBuffer {
    const gpu_buffer = create_gpu_buffer(device, bufferName, GPUBufferUsage.UNIFORM, 4);
